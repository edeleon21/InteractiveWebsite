...
// instructions is a variable for the instructions pop up window
let instructions = 0
...
function draw() {
  ...
  text('Press " I " for instructions.', 900, 40)
  ...
  // instructions is equal to 1 when "i" key is pressed and runs the instructionsWindow code
  if(instructions == 1){
    instructionsWindow()
...
// if t key is pressed, a tree is planted. if i key is pressed, instructions window pops up
function keyPressed(){
  if((key == 't')){
    x.push(random(50, windowWidth - 50))
    y.push(random(120, windowHeight - 50))
...
function instructionsWindow(){
  fill(196, 196, 196)
    strokeWeight(7)
    rect(windowWidth/2, windowHeight/2, 600, 120)
    fill(0)
    textSize(20)
    textAlign(CENTER, CENTER)
    text('Sustainably manage your forest. \n Click on a tree to harvest it and press "t" to plant a tree. \n \n Press "e" to exit', windowWidth/2, windowHeight/2)
}
